...
const meta: Meta<typeof StripesWrapper> = {
  component: StripesWrapper,
  render: (args) => (<StripesWrapper {...args}><StoryContent /></StripesWrapper>),
};

export default meta;

type Story = StoryObj<typeof StripesWrapper>;
